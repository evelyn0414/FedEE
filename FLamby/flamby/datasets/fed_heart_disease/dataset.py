...
class FedHeartDisease(HeartDiseaseRaw):
    ...
    def __init__(
        ...
        # print("pooled mean {} pooled std {} local mean {} local std {}", self.mean_of_features_pooled_train, self.std_of_features_pooled_train, self.mean_of_features, self.std_of_features)
        if train:
